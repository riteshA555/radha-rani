                        ...
                        <tr key={p.id} className="group hover:bg-gray-50/50 transition-colors">
                          ...
                          <td className="px-6 py-5 text-right">
                            <div className="flex flex-col items-end">
                              <span className={`text-base font-bold ${p.current_stock < (p.min_stock || invSettings?.lowStockThreshold || 5) ? 'text-rose-600' : 'text-gray-900'}`}>
                                {p.current_stock} <span className="text-[10px] text-gray-400 uppercase font-medium">Pcs</span>
                              </span>
                              {p.current_stock < (p.min_stock || invSettings?.lowStockThreshold || 5) && (
